        ...
        <div className="bg-gray-50 p-8 rounded-xl">
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/khanhtranprod" className="h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center hover:bg-blue-700 transition-colors">
